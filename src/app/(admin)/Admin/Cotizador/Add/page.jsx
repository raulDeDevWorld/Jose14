...
export default function Home() {
    ...
    return (
        <div className="min-h-full">
            ...
            <div className="fixed h-screen top-0 left-0 flex justify-center  w-full min-h-screen pt-[70px] bg-[#000000b4] p-0 z-40 " >
                <div className="relative max-h-full overflow-auto w-[95%] lg:w-[50%] bg-white border-b  pt-16 pb-16 lg:pb-4 px-5">
